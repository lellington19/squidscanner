...
public class SequenceFunctions
{
	...
	public static void main(String[] args)
	{
		...
		//r.runMotor(RXTXRobot.MOTOR1, 300, RXTXRobot.MOTOR2, -300, 5000); // Run both motors forward indefinitely
		r.sleep(1000);
		r.runMotor(RXTXRobot.MOTOR1, 250, RXTXRobot.MOTOR2, 250, 1800);
		r.close();
	}
}
